...
function draft(id, overrides = {}) {
  ...
  return {
    ...
    lastSeenAt: now, priceObservedAt: now, priceVerificationStatus: 'VERIFIED',
    priceTruthState: 'FRESH', duplicateStatus: 'CLEAR', claimValidationStatus: 'VERIFIED',
    sourceHash: `source-hash-${id}`, qualityScore: 90, qualityBand: 'good',
