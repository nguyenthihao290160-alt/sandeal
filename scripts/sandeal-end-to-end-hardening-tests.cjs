...
function approvedProduct(overrides = {}) {
  ...
  return scanProduct({
    ...
    linkHealthStatus: 'ok', linkLastCheckedAt: now, productUrlFinalDomain: 'merchant.example', productUrlHttpStatus: 200,
    affiliateHealthStatus: 'ok', affiliateLastCheckedAt: now, affiliateUrlVerifiedAt: now, affiliateUrlFinalDomain: 'merchant.example', affiliateUrlHttpStatus: 200,
    imageHealthStatus: 'ok', imageLastCheckedAt: now, duplicateStatus: 'CLEAR', claimValidationStatus: 'VERIFIED',
    reviewContent: {
