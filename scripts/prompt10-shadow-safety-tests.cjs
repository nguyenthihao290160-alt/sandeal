...
function candidate(sourceId, overrides = {}) {
  const payload = {
    ...
    canonicalProductUrl: `https://${sourceId}.merchant.example/products/headset`,
    ...
    canonicalUrlFetchedAt: '2026-07-16T00:00:00.000Z', canonicalUrlStatus: 'available',
    ...
    affiliateUrlFetchedAt: '2026-07-16T00:00:00.000Z', affiliateUrlStatus: 'available',
