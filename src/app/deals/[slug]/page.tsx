        ...
        <main>
          <section
              style={{
                padding: '32px 0 68px',
                background:
                    'radial-gradient(circle at 50% 0%, rgba(59,130,246,0.11), transparent 44%)',
              }}
          >
                  ...
                  >
                    {product.imageUrl ? (
                        ...
                        <div style={{ textAlign: 'center', color: '#94a3b8' }}>
                          <div style={{ fontSize: 42, fontWeight: 950, marginBottom: 8 }}>
                            S
                          </div>
                          <div style={{ fontWeight: 900 }}>
                            Ảnh sản phẩm đang cập nhật
                          </div>
                        </div>
                    )}
