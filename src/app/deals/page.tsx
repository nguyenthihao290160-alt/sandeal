...
function isPublicProduct(product: Product) {
  ...
  if (!product.affiliateUrl && !product.originalUrl && !record.url) return false;
...
function applyQuickFilter(products: Product[], activeFilter: string) {
  ...
  if (activeFilter === 'good_price') {
    return products.filter(
        (product) =>
            Boolean(product.salePrice && product.price && product.salePrice < product.price),
    );
  }
        ...
        <main>
          <section
              style={{
                ...
                textAlign: 'center',
                background:
                    'radial-gradient(circle at 50% 0%, rgba(59,130,246,0.13), transparent 46%)',
              }}
          >
            <div className="market-container">
              ...
              >
                ⚡ Hệ thống cập nhật giá tự động 24/7
              </div>
            ...
            <div className="market-container">
              ...
              >
                <div>
                  ...
                  <p style={{ color: '#64748b', margin: '8px 0 0' }}>
                    {loading
                        ? 'Đang tải dữ liệu...'
                        : `${visibleProducts.length} deal đủ điều kiện hiển thị`}
                  </p>
                </div>
                    ...
                    {Array.from({ length: 8 }).map((_, index) => (
                        <div
                            ...
                            style={{
                              ...
                              borderRadius: 22,
                              background:
                                  'linear-gradient(90deg, #ffffff 0%, #f1f5f9 45%, #ffffff 100%)',
                              border: '1px solid #e8edf5',
                            }}
                        />
                    ))}
              ...
              {!loading && visibleProducts.length === 0 && (
                  ...
                  >
                    ...
                    >
                      Hệ thống đang chờ nguồn sản phẩm thật từ AccessTrade hoặc nguồn
                      nội bộ. Voucher, chiến dịch và ưu đãi shop sẽ không public như
                      sản phẩm.
                    </p>
              ...
              {!loading && visibleProducts.length > 0 && (
                  ...
                  >
                    {visibleProducts.map((product) => {
                      ...
                      const buyUrl = product.affiliateUrl || product.originalUrl;
                      const score = product.score ?? 0;
          ...
          <section style={{ padding: '0 0 54px' }}>
            <div className="market-container" style={{ maxWidth: 880 }}>
              ...
              >
                ...
                Giá, tồn kho và ưu đãi có thể thay đổi theo thời gian. Một số liên
                kết trên SanDeal có thể là liên kết tiếp thị liên kết. SanDeal có thể
                nhận hoa hồng nếu bạn mua qua liên kết này, nhưng{' '}
