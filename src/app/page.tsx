        ...
        <main>
          ...
          >
            <div className="market-container" style={{ textAlign: 'center' }}>
              ...
              >
                <span>⚡</span>
                <span>Hệ thống cập nhật deal tự động 24/7</span>
              </div>
              ...
              >
                {[
                  ['⏱', 'Cập nhật giá', 'Làm mới liên tục.'],
                  ['🔗', 'Link minh bạch', 'Affiliate rõ ràng.'],
                  ['🛡', 'Ưu tiên uy tín', 'Nhà bán đáng tin.'],
                  ['📈', 'So sánh nhanh', 'Xem giá nổi bật.'],
                ].map(([icon, title, desc]) => (
                    <div
                        key={title}
                        style={{
            ...
            <div className="market-container">
              <div style={{ textAlign: 'center', marginBottom: 30 }}>
                ...
                <p style={{ color: '#64748b', margin: 0 }}>
                  Mọi deal đều phải qua 4 bước kiểm duyệt trước khi hiển thị.
                </p>
              </div>
              ...
              >
                {[
                  ...
                  ['2', 'AI lọc cơ hội', 'Loại bỏ deal ảo, chấm điểm rủi ro.'],
                  ['3', 'Kiểm tra link', 'Đảm bảo link affiliate an toàn, không bị hỏng.'],
                  ['4', 'Duyệt trước khi public', 'Admin kiểm tra lần cuối để đảm bảo chất lượng.'],
                ].map(([step, title, desc]) => (
                    <div
                        key={step}
                        style={{
