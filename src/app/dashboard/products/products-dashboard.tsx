      ...
      {!loading && !error && summary && (
        <>
          <section className={styles.primaryMetrics} aria-label="Tổng quan">
            ...
            <article className={styles.metricRed}><span className={styles.metricLabel}><i><DashboardIcon name="warning" size={20} /></i>Lượt chặn hoặc lỗi</span><strong>{summary.blockingSignals}</strong><small className={styles.metricHelp}>Tổng lượt blocked + link lỗi + ảnh lỗi; một sản phẩm có thể được tính nhiều lần.</small></article>
          </section>
