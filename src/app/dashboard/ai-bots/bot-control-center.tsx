...
type SafeJobDetail = Omit<AutomationJob, 'payload' | 'claimToken' | 'idempotencyKey'> & {
  candidateDiagnostics?: {
    status: string; reasonCode: string | null; retryable: boolean; attempts: number; nextRetryAt: string | null;
    affiliateGatewayDomain: string | null; merchantDomain: string | null; affiliateHealth: string; merchantHealth: string; lastProbeAt: string | null;
  } | null;
};
